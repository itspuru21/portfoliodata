...
However, adding a traditional CMS would destroy the elegant, database-less GitOps architecture I had spent [the last several days designing](#/blog/portfolio-blog-3-pivot-to-gitops). It would require a backend server, a database instance, and constant maintenance.
...
1.  Build an isolated, secure application within the `/admin` directory we created in [Blog 4](#/blog/portfolio-blog-4-laying-groundwork).
...
This is the ultimate expression of the "static-dynamic" hybrid approach. In [Blog 10](#/blog/portfolio-blog-10-building-bespoke-cms), I will break down exactly how I built this internal tool using React, and how it securely interfaces with the repository.